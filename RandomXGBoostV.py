...
class XGBRegressorWithEarlyStopping(BaseEstimator, RegressorMixin):
    def __init__(
        ...
        #min_split_gain=0, # 对应 CatBoost 的 min_delta
        subsample=1.0,
        ...
        #self.min_split_gain = min_split_gain # 对应 CatBoost 的 min_delta
    ...
    def fit(self, X, y, eval_set=None):
        ...
        current_model = xgb.XGBRegressor(
            ...
            #gamma=self.gamma,
            #min_split_gain=self.min_split_gain, # 对应 CatBoost 的 min_delta
...
if __name__ == "__main__":
    ...
    param_dist = {
        ...
        #'min_split_gain': randint(1, 6)      # 对应 min_samples_leaf
    ...
    for i in range(n_iterations):
        ...
        params = {
            ...
            #"min_split_gain": param_dist["min_split_gain"].rvs() # 如果使用 gamma 则不需要这个
        ...
        #min_split_gains.append(params["min_split_gain"])
        ...
        model = XGBRegressorWithEarlyStopping(
            ...
            #gamma=params["gamma"],
            #min_split_gain=params["min_split_gain"], # 如果使用 gamma 则不需要这个
    ...
    df = pd.DataFrame(
        {
            ...
            #"min_split_gain": [best_params["min_split_gain"]], # 修改为 min_split_gain
    ...
    df = pd.DataFrame(
        {
            ...
            #"min_split_gain": min_split_gains, # 修改为 min_split_gain
