...
if __name__ == "__main__":
    ...
    output_file_path = os.path.join(
        output_dir, f"LightGBM_{targets[0]}_Metrics_{current_time}.csv"
    )
    ...
    output_file_path = os.path.join(
        output_dir, f"LightGBM_{targets[0]}_Predictions_{current_time}.csv"
    )
    df.to_csv(output_file_path, index=False, encoding="utf-8-sig")
    ...
    output_file_path = os.path.join(
        output_dir, f"LightGBM_{targets[0]}_RMSE_History_{current_time}.csv"
    )
    df.to_csv(output_file_path, index=False, encoding="utf-8-sig")
    ...
    output_file_path = os.path.join(
        output_dir, f"LightGBM_{targets[0]}_Parameters_{current_time}.csv"
    )
    df.to_csv(output_file_path, index=False, encoding="utf-8-sig")
